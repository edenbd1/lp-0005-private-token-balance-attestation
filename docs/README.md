...
| File | What it covers |
|---|---|
| [architecture.md](./architecture.md) | End-to-end diagram, crate map |
| [design.md](./design.md) | Cryptographic design, threat model, public/private split |
| [security.md](./security.md) | Privacy guarantees, threat table, trust assumptions |
...
| [recon.md](./recon.md) | Verified facts about LEZ, SPEL, Logos Messaging |
